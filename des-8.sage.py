...
def key_schedule(keyByteList):
    ...
    Cn = []
    Dn = []
    Shift_Dis = [_sage_const_1, _sage_const_1, _sage_const_2, _sage_const_2, _sage_const_2,
                 _sage_const_2, _sage_const_2, _sage_const_2]  # 8 tour in the place of 16
...
def f(R, Kf):
    ...
    def f6to4(B, thisSbox):
        ...
        col = B[_sage_const_1] * (_sage_const_2 ** _sage_const_3) + B[_sage_const_2] * (
            _sage_const_2 ** _sage_const_2) + B[_sage_const_3] * _sage_const_2 + B[_sage_const_4]
...
def IntToList(x, n):
    ...
    L.reverse()
    # L est constitue d'elements de GF(2)
    L = [GF(_sage_const_2)(el) for el in L]
    return L
...
def proba_XY(K):
    X = [randint(GF(_sage_const_2)(_sage_const_0), _sage_const_1)
         for x in range(_sage_const_32)]
    Y = f(X, K)
    right = (Y[_sage_const_2] + Y[_sage_const_7] +
             Y[_sage_const_13] + Y[_sage_const_24]) % _sage_const_2
...
if(is_test):
    key = [randint(GF(_sage_const_2)(_sage_const_0), _sage_const_1)
           for x in range(_sage_const_48)]
...
if(is_test):
    ...
    for i in range(total):
        M = [randint(_sage_const_0, _sage_const_1)
             for m in range(_sage_const_64)]
        if(proba_LR(M, key)):
            nb_equal += _sage_const_1
...
def DES_L1_R1(key, L_or_R):
    ...
    L_1_1 = [randint(_sage_const_0, _sage_const_1)
             for m in range(_sage_const_32)]
    L_2_1 = copy(L_1_1)
    if (randint(_sage_const_1, _sage_const_2) == _sage_const_1):  # une difference
        ...
        L_2_1[_sage_const_1] = (L_2_1[_sage_const_1] +
                                _sage_const_1) % _sage_const_2
        L_2_1[_sage_const_2] = (L_2_1[_sage_const_2] +
                                _sage_const_1) % _sage_const_2
...
def find_key(msg_cipher, part_key):
    ...
    L7_1_16 = (f(msg_1[_sage_const_32:], part_key)[
               _sage_const_16] + msg_1[_sage_const_16]) % _sage_const_2
    L7_2_16 = (f(msg_2[_sage_const_32:], part_key)[
               _sage_const_16] + msg_2[_sage_const_16]) % _sage_const_2
...
def gen_M_change(m):
    ...
    for i in range(_sage_const_64):
        ...
        msg_tmp = copy(m)
        msg_tmp[_sage_const_8] = (
            msg_tmp[_sage_const_8] + bit_change[_sage_const_0]) % _sage_const_2
        msg_tmp[_sage_const_16] = (
            msg_tmp[_sage_const_16] + bit_change[_sage_const_1]) % _sage_const_2
        msg_tmp[_sage_const_22] = (
            msg_tmp[_sage_const_22] + bit_change[_sage_const_2]) % _sage_const_2
        msg_tmp[_sage_const_30] = (
            msg_tmp[_sage_const_30] + bit_change[_sage_const_3]) % _sage_const_2
        msg_tmp[_sage_const_33] = (
            msg_tmp[_sage_const_33] + bit_change[_sage_const_4]) % _sage_const_2
        msg_tmp[_sage_const_34] = (
            msg_tmp[_sage_const_34] + bit_change[_sage_const_5]) % _sage_const_2
        M.append(msg_tmp)
...
if(is_test):
    ...
    key8, proba = guess_bf_K8(c_and_c_star)
